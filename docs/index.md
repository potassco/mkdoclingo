...
**clindocs** is an automated documentation tool tailored for **Answer Set Programming (ASP)** code. Built on [MkDocs](https://www.mkdocs.org/) and [mkdocs-material](https://squidfunk.github.io/mkdocs-material/) as plugin, it streamlines the creation of high-quality documentation with the following features:
