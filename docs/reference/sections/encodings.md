...
- `include_path` Boolean indicating if the whole path of the encoding should be included in the section title, if it is false only the file name will be included. Defaults to False.
