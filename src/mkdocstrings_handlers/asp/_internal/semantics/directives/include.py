...
class Include:
    ...
    def resolve_path(self, base_path: Path) -> None:
        """
        Resolve the path of the included file relative to the given base path.

        Args:
            base_path: The base path.
        """
        self.path = (base_path.parent / self.path).resolve()
